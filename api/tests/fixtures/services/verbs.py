...
fake_performed_ai_translation_data = VerbTranslate(
    infinitive="anar",
    translation="ir",
    conjugation=[
        VerbMode(
            ...
            conjugation=[
                ...
                VerbConjugation(
                    pronoun="tu", forms=["vas"], variation_types=None, translation="vas"
                ),
                VerbConjugation(
                    pronoun="ell, ella, vostè",
                    forms=["va"],
        ...
        VerbMode(
            ...
            conjugation=[
                VerbConjugation(
                    pronoun="jo", forms=["aní"], variation_types=None, translation="fui"
                ),
                VerbConjugation(
                    pronoun="tu",
                    forms=["anares"],
        ...
        VerbMode(
            ...
            conjugation=[
                VerbConjugation(
                    ...
                    forms=["vaig anar"],
                    variation_types=None,
                    translation="fui a ir",
                ),
                VerbConjugation(
                    pronoun="tu",
                    forms=["vas (vares) anar"],
                    variation_types=None,
                    translation="fuiste a ir",
                ),
                VerbConjugation(
                    pronoun="ell, ella, vostè",
                    forms=["va anar"],
                    variation_types=None,
                    translation="fue a ir",
                ),
                VerbConjugation(
                    pronoun="nosaltres",
                    forms=["vam (vàrem) anar"],
                    variation_types=None,
                    translation="fuimos a ir",
                ),
                VerbConjugation(
                    pronoun="vosaltres, vós",
                    forms=["vau (vàreu) anar"],
                    variation_types=None,
                    translation="fuisteis a ir",
                ),
                VerbConjugation(
                    pronoun="ells, elles, vostès",
                    forms=["van (varen) anar"],
                    variation_types=None,
                    translation="fueron a ir",
                ),
            ],
        ),
        VerbMode(
        ...
        VerbMode(
            ...
            conjugation=[
                VerbConjugation(
                    ...
                    forms=["vaig haver anat"],
                    variation_types=None,
                    translation="hube ido a ir",
                ),
                VerbConjugation(
                    pronoun="tu",
                    forms=["vas haver anat"],
                    variation_types=None,
                    translation="hubiste ido a ir",
                ),
                VerbConjugation(
                    pronoun="ell, ella, vostè",
                    forms=["va haver anat"],
                    variation_types=None,
                    translation="hubo ido a ir",
                ),
                VerbConjugation(
                    pronoun="nosaltres",
                    forms=["vam haver anat"],
                    variation_types=None,
                    translation="hubimos ido a ir",
                ),
                VerbConjugation(
                    pronoun="vosaltres, vós",
                    forms=["vau haver anat"],
                    variation_types=None,
                    translation="hubisteis ido a ir",
                ),
                VerbConjugation(
                    pronoun="ells, elles, vostès",
                    forms=["van haver anat"],
                    variation_types=None,
                    translation="hubieron ido a ir",
                ),
            ],
        ),
        VerbMode(
    ...
    created_at=datetime.datetime(2023, 10, 1, 0, 0),
)
